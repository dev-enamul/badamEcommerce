...
use App\Http\Controllers\Api\UpayController;
...
use App\Http\Controllers\Api\BDPaymentController;
...
use App\Http\Controllers\Payment\UpayController as PaymentUpayController;
use App\Http\Controllers\Payment\NagadController as PaymentNagadController;
...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    // Route::get('all-featured-categories', [CategoryController::class, 'featured']);
    ...
    Route::post('bkash/pay', [BkashController::class, 'pay']);
    Route::get('bkash/get-token', [BkashController::class, 'getToken']);
    Route::get('bkash/create-payment/{total?}', [BkashController::class, 'createPayment']);
    Route::any('bkash/checkout-url/callback', [BkashController::class, 'callback']);
    ...
    Route::post('bkash/update-combined-order', [BkashController::class, 'updateTrnId']);
    Route::post('bkash/refund', [BkashController::class, 'bkashRefund']);
    Route::post('bkash/token', [BkashController::class, 'getToken']);

    Route::post('nagad/pay', [PaymentNagadController::class, 'createNagadPayment']);
    Route::get('upay/pay', [PaymentUpayController::class, 'upay']);
    
    Route::post('aamarpay/pay', [AamarpayController::class, 'aamarpay']);

    Route::get('get-bd-payment-methods', [BDPaymentController::class, 'bdPaymentMethod']);
