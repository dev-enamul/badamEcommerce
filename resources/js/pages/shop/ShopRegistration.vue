                    ...
                    <v-card class="border" elevation="0">
                        ...
                        <v-card-text>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" id="avatar-input" name="trade_license" accept="*" @change="tradeLicense">
                            </div>
                            <div class="mb-4">
                                <div class="mb-1 fs-13 fw-500">
                                    {{ $t("Bank Check") }}
                                </div>
                                <input type="file" id="avatar-input" name="bank_check" accept="*" @change="bankCheck">
                            </div>
                            <div class="mb-4">
                                <div class="mb-1 fs-13 fw-500">
                                    {{ $t("shop_phone") }}
                            ...
                            <div class="mb-4">
                                {{ $t("All Seller Agreement") }}
                                <a
                                    href="https://www.badami.com.bd/marketplace-seller-agreement"
                                    class=" primary--text text-decoration-underline "
                                >{{ $t("terms_and_conditions")}}</a>
                            </div>
                            <div class="mb-4">
                                {{ $t("Badami E Pharmacy Seller Agreement") }}
                                <a
                                    href="https://www.badami.com.bd/badami-E-Pharmacy-marketplace-seller-agreement"
                                    class=" primary--text text-decoration-underline "
                                >{{ $t("terms_and_conditions")}}</a>
                            </div>
                            <div class="mb-4">
                                {{ $t("BadamiMall Seller Agreement") }}
                                <a
                                    href="https://www.badami.com.bd/badamimall-marketplace-seller-agreement"
                                    class=" primary--text text-decoration-underline "
                                >{{ $t("terms_and_conditions")}}</a>
                            </div>
                            <div class="mb-4">
                                {{ $t("Digital Product Seller Agreement") }}
                                <a
                                    href="https://www.badami.com.bd/digital-goods-Marketplace-seller-agreement"
                                    class=" primary--text text-decoration-underline "
                                >{{ $t("terms_and_conditions")}}</a>
                            </div>
...
export default {
    ...
    computed:{
        ...
        nidErrors() {
            const errors = [];
            if (!this.$v.form.nid.$dirty) return errors;
            !this.$v.form.nid.required &&
                errors.push(this.$i18n.t("this_field_is_required"));
            return errors;
        },
        // tradeLicenseErrors() {
        //     const errors = [];
        //     if (!this.$v.form.tradeLicense.$dirty) return errors;
        //     !this.$v.form.tradeLicense.required &&
        //         errors.push(this.$i18n.t("this_file_is_required"));
        //     return errors;
        // },
        ...
        // bankCheckErrors() {
        //     const errors = [];
        //     if (!this.$v.form.bankCheck.$dirty) return errors;
        //     !this.$v.form.bankCheck.required &&
        //         errors.push(this.$i18n.t("this_file_is_required"));
        //     return errors;
        // },
        shopAddressErrors() {
    ...
    methods: {
        ...
        bankCheck(event){
            ...
            this.form.bank_check = event.target.files[0]
        ...
        async register() {
           ...
           for(var key in this.form){
            ...
            const res = await this.call_api("post", "shop/register", formData, true);
            if (res.data.success) {
                this.snack({
                    color: "green",
        ...
        resetForm(){
            ...
            this.form.phone = "";
            this.form.nid = "";
            // this.form.trade_license = "";
            // this.form.bank_check = "";
            this.form.email = "";
            this.form.password = "";
