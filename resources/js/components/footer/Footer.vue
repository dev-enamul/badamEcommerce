<template>
    ...
    <footer class="grey darken-4 pt-8 white--text pb-14 pb-md-10 pb-lg-0">
        <v-row class="justify-center">
            <!-- <v-col cols="3"></v-col>
            <v-col class="d-flex align-items-sm-center" cols="6" sm="6" md="6" lg="6" >
                <h3 class="text-center py-2">Our Payment Gateway</h3>
            </v-col> -->

            <v-col class="d-flex align-items-sm-center align-items-md-center align-items-lg-center" cols="10" sm="10" md="10" lg="10" >
                
                <ul class="payment-method-img d-flex align-items-center">
                    <li>
                        <img :src="image_path + '/assets/img/cards/payment-partners.png'" class="img-fluid bg-white"/>
                        <img :src="image_path + '/assets/img/cards/footer-payment-with.png'" class="img-fluid bg-white"/>
                    </li>
                </ul>
            </v-col>
            <!-- <v-col cols="3"></v-col> -->
