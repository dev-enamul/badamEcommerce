            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">
                                {{-- {{ translate('Have Commission?') }} --}}
                            </label>
                            <div class="col-md-9">
                                <input type="checkbox" checked="{{$category->commission > 0?true:false}}" id="is_commission"><span> Have Commission?</span>
                                {{-- <small>{{ translate('Higher number has high priority') }}</small> --}}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="commission" value="{{ $category->commission }}"
                                    class="form-control" id="commission" placeholder="{{ translate('e.g. 10.00') }}">
                                {{-- <small>{{ translate('Higher number has high priority') }}</small> --}}
                            </div>
                        </div>
                        <div class="form-group row">
