                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="border border-dotted rounded py-2 px-3 mr-3 ml-0 bg-danger text-white">
                        ...
                        <div class="opacity-60 fs-12">
                            ...
                            -
                            {{ \Carbon\Carbon::createFromTimestamp($product->discount_end_date)->toDateTimeString() }}
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            ...
                            <div class="input-group-append"><span class="input-group-text">{{ get_setting('weight_unit')
                                    }}</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            <input type="number" class="form-control" name="width" min="0" value="{{ $product->width }}"
                                required readonly>
                            <div class="input-group-append"><span class="input-group-text">{{
                                    get_setting('dimension_unit') }}</span></div>
                        </div>
