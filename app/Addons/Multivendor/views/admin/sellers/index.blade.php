            ...
            <table class="table aiz-table mb-0">
                ...
                @foreach($shops as $key => $shop)
                    <tr>
                        ...
                        <td>{{ $shop->nid}}</td>
                        <td><a href="/uploads/doc/{{$shop->trade_license}}" download>{{$shop->trade_license}}</a></td>
                        <td><a href="/uploads/doc/{{$shop->bank_check}}">{{$shop->bank_check}}</a></td>
                        <td>
